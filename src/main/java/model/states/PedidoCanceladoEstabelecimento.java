...
public class PedidoCanceladoEstabelecimento extends State {

    public PedidoCanceladoEstabelecimento(Pedido pedido) {
        super(pedido);
    }

    @Override
    PedidoStateEnum getStatus() {
        return PedidoStateEnum.CANCELADO_ESTABELECIMENTO;
    }
